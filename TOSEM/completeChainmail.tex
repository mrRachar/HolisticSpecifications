%%% New merged Chainmail alternative

In this section we introduce and formally define
\Chainmail. \Chainmail assertions (details in appendix \ref{sect:standard}) consist of (pure) expressions \e, comparisons between expressions, classical
